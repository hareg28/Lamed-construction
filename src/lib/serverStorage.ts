import { projects as seedProjects, news as seedNews, inquiries as seedInquiries, certificates as seedCertificates, admin as seedAdmin } from '@/lib/seedData';
...
export function createCertificate(body: { title: string; image: string; issuer?: string; year?: string; description?: string }): Certificate {
  ensureInit();
